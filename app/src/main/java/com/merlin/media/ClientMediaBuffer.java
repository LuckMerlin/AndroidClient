...
//
//public final class ClientMediaBuffer extends MediaBuffer<Music> {
//    private final Client mClient;
//    private final String mCachePath;
//    private Reader mReader;
//
//    public ClientMediaBuffer(Client client, Music media, double seek){
//        super(media,seek);
...
//                    Debug.D(getClass(),"Music file head got."+account+" "+url);
