...
//
//
//public abstract class FileBrowser<T extends FileMeta>  extends Retrofit implements OnTapClick, OnLongClick, Model.OnActivityBackPress {
...
//
//    public FileBrowser(Context context, ClientMeta meta){
//        mClientMeta=meta;
//        mContext=null!=context?new WeakReference<>(context):null;
//    }
//
//    protected void onBrowserModeChange(FileBrowser model, int last, int mode){
//        //Do nothing
//    }
//
//    protected void onPageDataLoad(FileBrowser model, PageData<? extends FileMeta> page){
//        //Do nothing
//    }
//
...
//                    if (isMode(FileBrowser.MODE_MULTI_CHOOSE)) {
...
//            int last=mMode;
//            mMode=mode;
//            onBrowserModeChange(this,last,mode);
//            BrowserAdapter adapter=mBrowserAdapter;
//            if (null!=adapter){
