...
// *
// */
//final class LifeBinderImpl_temp implements Application.ActivityLifecycleCallbacks,ComponentCallbacks{
//    private static LifeBinderImpl_temp mLifeNotify;
...
//        void onLifeBind(Application application, boolean enable, LifeBinderImpl_temp notify);
//    }
//
//    private LifeBinderImpl_temp(){
//
//    }
//
...
//                LifeBinderImpl_temp lifeNotify=mLifeNotify;
//                lifeNotify=enable&&null==lifeNotify?(mLifeNotify=new LifeBinderImpl_temp()):lifeNotify;
//                if (null!=lifeNotify){
