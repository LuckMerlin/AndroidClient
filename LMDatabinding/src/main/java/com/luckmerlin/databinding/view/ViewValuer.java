    ...
    public boolean set(View view, Object value){
        if (null!=view&&null!=value){
            if (value instanceof Text){
                return setViewText(view,(Text)value);
            }else if (value instanceof Image){
                return setViewImage(view,(Image)value);
            }else if (value instanceof Event){
//                return setViewEvent(view,(Event)value);
            }else if (value instanceof Tag){
                Tag tag=(Tag)value;
                return setViewTag(view,tag.getObject(),null);
            }
    ...
    final boolean setViewEvent(View view,Event event){
        if (null!=view){
            setViewTag(view, event.getTag(), "While set view event.");
            return true;
        }
        return false;
    }
