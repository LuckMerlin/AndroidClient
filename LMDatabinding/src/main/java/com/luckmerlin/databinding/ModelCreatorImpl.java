...
class ModelCreatorImpl extends ModelClassFinder {
        ...
        if (null!=object){
            ...
            if (null!=object&&object instanceof ViewDataBinding){
                ...
                if (null!=matchBinding){
                    ...
                    if (null!=current&&current instanceof LModel){//Already create and bound
                        return new CreatedModel((LModel)current,root,matchBinding);
                    }
                    object=matchBinding;
                }
            }
            ...
            if (null==modelClass||!isExistClass(modelClass,LModel.class.getName())|| Modifier.isAbstract(modelClass.getModifiers())){
                return null;
            }
            ...
            LModel model=null!=object&&object instanceof LModel?(LModel)object:null;
